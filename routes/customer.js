...
router.get('/products', async (req, res) => {
  try {
    const { search, category } = req.query;
    console.log("Received Search Query:", req.query); // Debugging
    console.log("Received Category Query:", category); // Debugging
    let filter = {};
    ...
    if (category && category !== "All Categories") {
      filter.category = category; // exact match or tweak to use regex if needed
    }
